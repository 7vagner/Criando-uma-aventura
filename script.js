function makeChoice(choice) {
    ...
    if (choice === 'explorar') {
        ...
        storyText.innerHTML += '<br><button onclick="makeChoice(\'norte\')">Ir para o norte</button>';
        storyText.innerHTML += '<button onclick="makeChoice(\'sul\')">Ir para o sul</button>';
        ...
        storyText.innerHTML += '<br><button onclick="makeChoice(\'brincar\')">Brincar com os peixes</button>';
        storyText.innerHTML += '<button onclick="makeChoice(\'explorar-lago\')">Explorar o lago</button>';
        ...
        storyText.innerHTML += '<br><button onclick="makeChoice(\'descansar\')">Descansar</button>';
        storyText.innerHTML += '<button onclick="makeChoice(\'procurar\')">Procurar aventuras</button>';
