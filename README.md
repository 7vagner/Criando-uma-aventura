...
<head>
    ...
    <title>O Cãozinho Aventureiro</title>
</head>
<body>
    <main>
        <div class="passo ativo" id="passo-0">
            <img src="img/cenario-passo0.png" alt="">
            <p>Era uma vez um cãozinho chamado Pipo. Ele era muito curioso e adorava explorar novos lugares.</p>
            <button class="btn-proximo" data-proximo="1">Casa</button>
            <button class="btn-proximo" data-proximo="2">Floresta</button>
        </div>
        <div class="passo" id="passo-1">
            <p>Um dia, Pipo decidiu sair da casinha e se aventurar pela floresta.</p>
            <button class="btn-proximo" data-proximo="3">Sair de casa</button>
            <button class="btn-proximo" data-proximo="4">Se aventurar na floresta</button>
        </div>
        <div class="passo" id="passo-2">
            <p>Ele pulou por entre as árvores e encontrou animais diferentes.</p>
            <button class="btn-proximo" data-proximo="5">Pulou nas árvores</button>
            <button class="btn-proximo" data-proximo="6">Encontrou animais</button>
        </div>
        <div class="passo" id="passo-3">
            <p>Fez amizade com o macaco, o coelho e até um bicho preguiça dorminhoco.</p>
            <button class="btn-proximo" data-proximo="7">Fez amizades</button>
        </div>
